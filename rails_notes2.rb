...
rails new blog -T --database=postgresql => -T removes test framework, --database=postgresql => uses postgres instead of sqlite
Type: rails db:create => creates database
